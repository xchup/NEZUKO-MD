...
command({
    ...
    const name = '𝙶𝙾𝙳 𝚉𝙴𝙽𝙾𝚇', title = "𝙉𝙀𝙕𝙐𝙆𝙊 𝙎𝙐𝙋𝙋𝙊𝙍𝙏🦋", number = '919744108970', body = "𝙶𝙾𝙳 𝚉𝙴𝙽𝙾𝚇⛒";
    const image = "https://files.catbox.moe/spmaxi.png", sourceUrl = 'https://instagram.com/starry.zenox';
